...
/*
 * Looks like: qrtr:N:N
 * Based on Yassine Oudjana's new-style implementation, adapted to old-style
 * file2alias API by Marc Lainez <marc.lainez@gmail.com>
 */
static int do_qrtr_entry(const char *filename, void *symval, char *alias)
{
